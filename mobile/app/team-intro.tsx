...
const makeStyles = (theme: Theme) => StyleSheet.create({
  ...
  ovrNum: { color: theme.isDark ? theme.accent : theme.text, fontSize: 17, fontWeight: '900' },
  ovrLabel: { color: theme.textMute, fontSize: 8, fontWeight: '800' },
  ...
  bio: { color: theme.textMute, fontSize: 12, marginTop: 10, lineHeight: 17 },
  noBio: { color: theme.textFaint, fontSize: 12, marginTop: 10, fontStyle: 'italic' },
})
