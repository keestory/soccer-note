      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="max-w-none space-y-8 leading-relaxed" style={{ color: 'rgba(255,255,255,0.7)' }}>
          ...
          <section>
            ...
            <h3 className="text-lg font-medium text-white/80 mt-4 mb-2">가. 회원가입 및 계정 관리</h3>
            ...
            <h3 className="text-lg font-medium text-white/80 mt-4 mb-2">나. 팀 및 경기 관리</h3>
            <ul className="list-disc pl-6 space-y-1">
            ...
            <h3 className="text-lg font-medium text-white/80 mt-4 mb-2">다. 미디어</h3>
            <ul className="list-disc pl-6 space-y-1">
              <li>경기 관련 사진 및 동영상 (사용자가 직접 업로드한 경우)</li>
            </ul>

            <h3 className="text-lg font-medium text-white/80 mt-4 mb-2">라. 푸시 알림</h3>
            <ul className="list-disc pl-6 space-y-1">
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-3">3. 개인정보 수집 및 이용 목적</h2>
            <ul className="list-disc pl-6 space-y-1">
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-3">4. 개인정보 보유 및 파기</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-3">5. 제3자 제공 및 위탁</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-3">6. 미성년자 개인정보 보호</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-3">7. 이용자의 권리</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-3">8. 보안 조치</h2>
            <ul className="list-disc pl-6 space-y-1">
              <li>비밀번호 암호화 저장</li>
              <li>HTTPS 통신 암호화</li>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-3">9. 쿠키 및 자동 수집 정보</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-3">10. 개인정보 처리방침 변경</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-3">11. 연락처</h2>
            <p>
        ...
        <div className="mt-12 pt-8 text-center text-sm" style={{ borderTop: "1px solid #2a2a2a", color: "rgba(255,255,255,0.3)" }}>
