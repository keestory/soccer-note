...
function JoinTeamContent() {
  ...
  const renderStatusMessage = () => {
    ...
    switch (existingStatus) {
      ...
      case 'approved':
        return (
          <div className="border-2 border-primary-200 bg-primary-50 rounded-xl p-6 mb-6">
            <div className="flex items-center gap-3 mb-3">
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <form onSubmit={handleSearch} className="mb-6">
            <div className="flex gap-2">
              <input
                ...
                maxLength={8}
                className="flex-1 px-4 py-3 border rounded-lg text-center text-lg font-mono tracking-widest uppercase focus:ring-2 focus:ring-primary-500 outline-none"
              />
              <button
                type="submit"
          ...
          <div className="text-center">
            <Link href="/dashboard" className="text-primary-600 hover:underline flex items-center justify-center gap-1">
